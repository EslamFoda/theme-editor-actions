...
const Design5 = () => {
  const data = [
    {
      icon: <HiOutlineSupport className="text-secondary" size={7} />,
    ...
    {
      icon: <HiOutlineUsers className="text-secondary" size={7} />,
    ...
    {
      icon: <HiOutlineBriefcase className="text-secondary" size={7} />,
    ...
    {
      icon: <TbAsteriskSimple className="text-secondary" size={7} />,
